...
import '../../../domain/models/pigmento.dart';  // CORREGIDO: 3 niveles hacia arriba
import '../../../domain/services/transformador_color.dart';  // CORREGIDO

/// Widget accesible para seleccionar un pigmento de una lista.
/// Soporta lectores de pantalla (Semantics) y modos de daltonismo.
class ColorPickerAccesible extends StatelessWidget {
  final List<Pigmento> pigmentosDisponibles;
  final Pigmento? pigmentoSeleccionado;  // Puede ser null
      ...
      children: [
        ...
        Wrap(
          ...
          children: pigmentosDisponibles.map((pigmento) {
            final isSelected = pigmento.id == pigmentoSeleccionado?.id;  // Safe con ?.
